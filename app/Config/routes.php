 ...
 */
	...
	Router::connect($urlBase.'versions/update/*', array('controller' => 'versions', 'action' => 'update'));
	Router::connect($urlBase.'versions/history/*', array('controller' => 'versions', 'action' => 'downloadHistory'));
	// UsersController
    ...
    // ExportsController
 	...
 	// test
 	Router::connect($urlBase.'partner', array('controller' => 'videos', 'action' => 'index'));
