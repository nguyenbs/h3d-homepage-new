...
$breadcrumb = array('name' => 'Cài đặt',
    'url' => $urlPlugins . 'theme/theme/house3d-admin-3dvrCloudMediaSetting.php',
    'sub' => array('name' => 'Cài đặt trang 3DVR CloudMedia')
);
            ...
            <td >
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="col-md-9">
                            <textarea class="form-control" rows="2" name="BannerMota2"><?php echo @$themeData['Option']['value']['BannerMota2'];?></textarea>
                        </div>
                    </div>
                    <div class="col-md-3"></div>
                </div>
        ...
        <tr>
            <td>
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <p class="text-center p-center">Tiêu đề khối</p>
                        <input type="text" class="form-control" placeholder="" name="AlbumThietKeTieuDe" value="<?php echo @$themeData['Option']['value']['AlbumThietKeTieuDe'];?>">
                        <br>
