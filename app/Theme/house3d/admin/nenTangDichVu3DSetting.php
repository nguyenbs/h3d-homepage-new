...
$breadcrumb = array('name' => 'Cài đặt',
    'url' => $urlPlugins . 'theme/theme/house3d-admin-nenTangDichVu3DSetting.php',
    'sub' => array('name' => 'Cài đặt trang nền tảng dịch vụ dựng 3D')
);
    ...
    <table class="table table-hover table-border table-list">
        ...
        <tr>
            <td>
                <div class="row">
                    <div class="col-md-12">
                        <p class="bold-center" style="color:red">KHỐI DỊCH VỤ DỰNG</p>
                    </div>
                    <div class="col-md-6">
