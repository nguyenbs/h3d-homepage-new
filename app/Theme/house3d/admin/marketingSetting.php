...
$breadcrumb = array('name' => 'Cài đặt',
    'url' => $urlPlugins . 'theme/theme/house3d-admin-3dvrarMarketingSetting.php',
    'sub' => array('name' => 'Cài đặt trang 3D/VR/AR MARKETING')
);
        ...
        <tr>
            <td>
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <p class="text-center p-center">Tiêu đề khối</p>
                        <input type="text" class="form-control" placeholder="" name="ThietKeAnTuongTieuDe" value="<?php echo @$themeData['Option']['value']['ThietKeAnTuongTieuDe'];?>">
                        <br>
