        ...
        <div class="sectwo_designtools_out secone_designtools_out_bg1" style="background: rgba(60,151,100,1);">
          <div class="sectwo_designtools_in">
           <div class="text-center sectwo_designtools_text">
            <h1><?php echo @$nenTangDichVu3DSetting['Option']['value']['BannerMota1'];?> <br> <?php echo @$nenTangDichVu3DSetting['Option']['value']['BannerMota2'];?></h1>
        </div>

        <div class="sectwo_designtools_bot">
            <p>
                <?php echo @$nenTangDichVu3DSetting['Option']['value']['BannerMota3'];?>
                <br>
                <?php echo @$nenTangDichVu3DSetting['Option']['value']['BannerMota4'];?>
            </p>
        </div>
    </div>
</div>
        ...
        <div class="row">
            <div class="col-lg-5 offset-lg-1 col-md-5 offset-md-1 od_second" >
                <div class="secone_info ">
                    ...
                    <div class="secone_info_tit">
                        <p><?php echo @$nenTangDichVu3DSetting['Option']['value']['CongCuTkND1TieuDe'];?></p>
                    </div>
                    <div class="secone_info_des">
                        <p>
                            <?php echo @$nenTangDichVu3DSetting['Option']['value']['CongCuTkND1NoiDung'];?>
                        </p>
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-md-6 od_first">
                <div class="secone_img flex_end tilt"  data-tilt data-tilt-glare="true" data-tilt-scale="1">
                    <img src="<?php echo hashUrl(@$nenTangDichVu3DSetting['Option']['value']['CongCuTkND1Video']);?>" class="img-fluid " title="Hỗ trợ tạo thiết kế nhanh bằng cách lựa chọn từ thư viện hoặc import từ file CAD.">
                </div>
            </div>
        </div>

        <div class="row secone_info_margintop75">
            <div class="col-lg-6 col-md-6 od_first">
                <div class="secone_img tilt"  data-tilt data-tilt-glare="true" data-tilt-scale="1">
                    <img src="<?php echo hashUrl(@$nenTangDichVu3DSetting['Option']['value']['CongCuTkND2Video']);?>" class="img-fluid" title="Triển khai ý tưởng thiết kế cho ngôi nhà bằng thao tác kéo thả trực quan.">
                </div>
            </div>
            <div class="col-lg-5 col-md-5 od_second" >
                <div class="secone_info ">
                    ...
                    <div class="secone_info_tit">
                        <p><?php echo @$nenTangDichVu3DSetting['Option']['value']['CongCuTkND2TieuDe'];?></p>
                    </div>
                    <div class="secone_info_des">
                        <p>
                            <?php echo @$nenTangDichVu3DSetting['Option']['value']['CongCuTkND2NoiDung'];?>
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="container-fluid">
                        <div class="secone_part1_pf">
                            <div class="text-center secone_title">
                                <h1><?php echo @$nenTangDichVu3DSetting['Option']['value']['AlbumThietKeTieuDe'];?></h1>
                    ...
                    <div class="main_gallary">
                        <div class="col-lg-10 my-auto mx-auto">
                            <div class="row row_gallery">
                                <?php
                                global $modelAlbum;
                                if(!empty($nenTangDichVu3DSetting['Option']['value']['ThietKeAlbum'])){
                                    $album = $modelAlbum->getAlbum($nenTangDichVu3DSetting['Option']['value']['ThietKeAlbum']);
                                    ?>
