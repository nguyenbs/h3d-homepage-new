...
// Quan ly thong tin chung
       ...
       function saveInfoSite($data)
       {
         ...
         $this->saveOption('contact', $optionGroup);

         $captchaGroup = array(
             'secretKey' => $data['secretKey'],
             'siteKey' => $data['siteKey']
         );
         $this->saveOption('captchaData', $captchaGroup);
...
//         $groupsContact['Option']['value']['cdn']= $data['cdn'];
//         $this->create();
//         $this->saveOption('contact',$groupsContact);
